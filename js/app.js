  ...
  function initApp() {
    ...
    window.updatePredictionUI = function() {
      ...
      if (targetZ >= apogee - 50.0) {
        ...
        // Active 4-fin Proportional Navigation trajectory shaping & glide homing envelope
        ...
        if (targetX >= minReach && targetX <= maxReach) {
          // TARGET HIT: ProNav guidance actively locks on and guides vehicle to target
